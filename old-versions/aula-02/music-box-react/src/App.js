...
function App() {
  ...
  return (
    /* diamond (tag vazia) representa o React.Fragment, e serve para englobarmos um conteúdo sem necessariamente termos um elemento (ao renderizar, ele é removido do código)  */
    <>
      <h1>Músicas</h1>
      <h1>{musicas}</h1>
